    ...
    <div class=" ui-widget-overlay">
        <div class="col-sm-5 "   style="margin-top:20%;">
            ...
            <form  name="AuthForm" ng-submit="SubmitForm()" >
                ...
                <button type="submit" class="btn btn-primary trackBtn"><span class="glyphicon glyphicon-log-in"></span></button>
            </form>
        </div>
        <h1 class="col-sm-1 text_loginPage" style="padding-left:5%">or</h1>
        <div class="col-sm-5" style="margin-top:20%; padding-left: 12%">
            <button class="returnBtn" ng-click="openDialog()" >I want to return an item<p>generate a new case</p></button>
        </div>
    </div>
    <div class="dialogForm" title="Eingabe" hidden >
        <div class="col-sm-1">
            <form>
                ...
                <button type="submit" class="btn btn-primary" ng-click="send()"><span class="glyphicon glyphicon-log-in"></span></button>
                <button type="button" class="btn btn-danger" ng-click="close()"><span class="glyphicon glyphicon-remove"></span></button>
            </form>
        </div>
    </div>
