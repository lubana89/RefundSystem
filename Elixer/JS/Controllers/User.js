    ...
    function AuthController($auth, $state, $http, $rootScope,ApiSVC) {
        ...
        vm.login = function() {
            ...
            $auth.login(credentials).then(function() {
                //set token globally for ajax calls from factories
    ...
    angular
        ...
        .factory('ApiSVC', ['$http', '$auth', function ($http, $auth) {
            ...
            factory.GetAllWarehouseUsers = function () {
                return $http.get(configuration.path + '/api/AllWarehouseUsers'+token);

            };
            factory.UpdateNotification = function (notification) {
                return $http.post(configuration.path + '/api/UpdateNotification'+token, JSON.stringify(notification));
            };
            factory.GetAuthenticatedUser = function () {
                return $http.get(configuration.path + '/api/authenticate/user'+token);
            };
            factory.GetRole = function () {
                return $http.get(configuration.path + '/api/GetRole'+token);
            };
            factory.GetAllUsers = function () {
                return $http.get(configuration.path + '/api/Users'+token);
            };
            factory.UpdateUser = function (data) {
                return $http.post(configuration.path + '/api/UpdateUser'+token, JSON.stringify(data));
            };
            factory.CreateUser = function (data) {
                return $http.post(configuration.path + '/api/CreateUser'+token, JSON.stringify(data));
            };
            factory.GetAllRoles = function () {
                return $http.get(configuration.path + '/api/Roles'+token);
            };
            factory.AssignRole = function (userData) {
                return $http.post(configuration.path + '/api/AssignRole'+token, JSON.stringify(userData));
            };
            factory.DeleteUser = function (id) {
                return $http.get(configuration.path + '/api/DeleteUser/' + id + token);
            };
            factory.GetAllCase=function () {
                return   $http.get(configuration.path + '/api/AllCases'+token);
            };
            return factory;
        }]);
})();
    ...
    angular
        ...
        .factory('CommunicationSVC', ['$http', '$auth', function ($http, $auth) {
            ...
            factory.GetAllNotifications = function () {
                return $http.get(configuration.path + '/Communication/GetAllNotifications/' + user.id +token);
            };
            factory.MarkReadNotification = function (id) {
                return $http.get(configuration.path + '/Communication/MarkRead/' + id +token );
            };
            factory.MarkUnReadNotification = function (id) {
                return $http.get(configuration.path + '/Communication/MarkUnRead/' + id + token);
            };
            factory.GetMessageChain = function (id) {
                return $http.get(configuration.path + '/Communication/GetChainNotifications/' + id + token);
            };
            factory.ReplyNotification = function (notification) {
                return $http.post(configuration.path + '/Communication/ReplyNotification'+token, JSON.stringify(notification));
            };
            factory.FileUplod=function (id) {
             return   configuration.path + '/Communication/File/Upload/'+id+ token;
            };
            factory.GetNotificationCount=function () {
              return  $http.get(configuration.path + '/Communication/GetNotificationCount/' + user.id + token);
            };
            factory.GetTopFiveNotification=function () {
                return $http.get(configuration.path+'/Communication/GetTopFiveNotifications/'+user.id+ token);
            };
            factory.MarkAllNotificationRead=function () {
               return $http.get(configuration.path + '/Communication/MarkAllNotificationRead/' + user.id + token);
            };
            factory.GetAllMessages=function (id) {
             return   $http.get(configuration.path + '/Communication/GetAllMessage/' +id + token);
            };
            factory.GetAllImages=function (id) {
             return   $http.get(configuration.path + '/Communication/File/GetAllImages/' +id + token);
            };
            factory.SendNotification=function (notification) {
               return $http.post(configuration.path+'/Communication/SendNotification'+token, JSON.stringify(notification))
            };
            factory.AddMessage=function (message) {
               return $http.post(configuration.path+'/Communication/AddMessage'+token, JSON.stringify(message));
            };
            return factory;
        }]);
})();
    ...
    angular
        ...
        .factory('SellerSVC', ['$http', '$auth', function ($http, $auth) {
            ...
            factory.GenerateRefundLink = function (data) {
                return $http.post(configuration.path + '/Seller/GenerateRefundLink' + token, JSON.stringify(data));

            };
            factory.GetAllSellerCase = function () {
                return $http.get(configuration.path + '/Seller/AllCases/' + user.id + token);
            };
            factory.UpdateCaseData = function (id,data) {
                return $http.post(configuration.path + '/Seller/UpdateCaseData/' + id + token, JSON.stringify(data))
            };
            factory.GetLink = function (id) {
                return $http.get(configuration.path + '/Seller/GetLink/' + id + token);
            };
            factory.DeleteCase = function (id) {
                return $http.get(configuration.path + '/Seller/DeleteCase/' + id + token);
            };
            factory.GetAllAdmins=function () {
              return  $http.get(configuration.path + '/Seller/GetAllAdmins'+token);
            };
            return factory;
        }]);
})();
(function () {
    ...
    angular
        ...
        .factory('WarehouseSVC', ['$http', '$auth', function ($http, $auth) {
            var factory = {};
            factory.GetAllSellers = function (data) {
                return $http.get(configuration.path + '/Warehouse/GetAllSellers' + token);

            };
            factory.SearchReturnedCase = function (Search) {
                return $http.get(configuration.path + '/Warehouse/ReturnedCase/' + Search + token);
            };
            factory.UpdateCaseStatus=function (Status) {
              return  $http.post(configuration.path+'/Warehouse/UpdateCaseStatus'+token, JSON.stringify(Status));
            };
            factory.UpdateCaseData=function (id,data) {
              return  $http.post(configuration.path+'/Warehouse/UpdateCaseData/'+id+ token, JSON.stringify(data))
            };
            return factory;
        }]);
})();
